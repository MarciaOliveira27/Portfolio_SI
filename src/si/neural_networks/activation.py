...
class TanhActivation(ActivationLayer):
    ...
    def activation_function(self, input: np.ndarray):
        ...
        activation_formula = num / den
        return activation_formula
    ...
    def derivative(self, input: np.ndarray):
        ...
        numpy.ndarray
            The derivative of the activation function.
        """
        derivative_formula = 1 - (self.activation_function(input) ** 2)
...
class SoftmaxActivation(ActivationLayer):
    ...
    def activation_function(self, input: np.ndarray):
        ...
        modified_input = input - np.max(input, axis=0, keepdims=True)
        num = np.exp(modified_input)
    ...
    def derivative(self, input: np.ndarray):
        ...
        numpy.ndarray
            The derivative of the activation function.
        """
        derivative_formula = self.activation_function(input) * (1 - self.activation_function(input))
        return derivative_formula